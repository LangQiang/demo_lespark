...
public class CircularRelativeLayout extends FrameLayout {
    ...
    public CircularRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        topLeftRadius = UIHelper.dip2px(4);
        topRightRadius = UIHelper.dip2px(4);
        bottomLeftRadius = UIHelper.dip2px(4);
        bottomRightRadius = UIHelper.dip2px(4);
