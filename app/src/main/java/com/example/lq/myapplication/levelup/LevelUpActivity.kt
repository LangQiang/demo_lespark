...
class LevelUpActivity : AppCompatActivity() {
    ...
    private fun show(rl : RelativeLayout?) {
        ...
        animSet.play(wingLeftAnimTranslationX).after(containerAnimY)
        animSet.play(wingLeftAnimTranslationY).after(containerAnimY)
        animSet.play(wingRightAnimRotate).after(containerAnimY)
        animSet.play(wingRightAnimTranslationX).after(containerAnimY)
        animSet.play(wingRightAnimTranslationY).after(containerAnimY)
